...
$query = "SELECT checkingbalance, savingsbalance, investmentbalance FROM users WHERE user_id = ?";
$stmt = $pdo->prepare($query);
$stmt->execute([$user_id]);
$result = $stmt->fetch(PDO::FETCH_ASSOC);

if ($result && isset($result['checkingbalance']) && isset($result['savingsbalance']) && isset($result['investmentbalance'])) {
    $checking_balance = $result['checkingbalance'];
    $saving_balance = $result['savingsbalance'];
    $investment_balance = $result['investmentbalance'];
}else{
    $checking_balance = "balance not found";
    $saving_balance = "balance not found";
    $investment_balance = "balance not found";
}
// Example array of account types and initial balances (can be fetched dynamically from database)
$accountTypes = [
    ['name' => 'Checking Account', 'balance' => 1000],
...
<body>
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="transfer_requests.php">Transfer Requests</a>
                            <a href="#">Settings</a>
    ...
    <div class="dashboard">
        <div class="profile">
            <div class="profile-picture">
                ...
                <img src="avatar.jpeg" alt="Profile Picture" id="profile-img">
                ...
                <input type="file" name="profile photo"accept="image/*" id="upload" onchange="previewimage(event);">
</form>
        ...
        <div class="accounts-container">
            ...
            <div class="accounts-slider">
                <div class="account"><h3>Checking account</h3><p class="balance"><?php echo htmlspecialchars($checking_balance); ?></p>
                </div>
                <div class="account">
                    <h3>Savings Account</h3>
                    <p class="balance"><?php echo htmlspecialchars($saving_balance); ?></p>
                </div>
                <div class="account">
                    <h3>Investment Account</h3>
                    <p class="balance"><?php echo htmlspecialchars($investment_balance); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="transactions">
            ...
            <div class="transactions-slider">
                <div class="transfer">
                    ...
                    <a href="external_transfer.php" class="transfer-link">Initiate Transfer</a>
                </div>
                <div class="transfer">
                    <h3>Internal Transfer</h3>
                    <p>Transfer funds within your accounts</p>
                    <a href="internal_transfer.php" class="transfer-link">Initiate Transfer</a>
                </div>
            </div>
        </div>
        ...
        <div class="deposits">
            ...
            <div class="deposits-slider">
                <div class="deposit">
                    ...
                    <a href="deposit.php" class="deposit-link">Initiate Deposit</a>
                </div>
                <div class="deposit">
                    <h3>Wire Transfer Deposit</h3>
                    <p>Deposit funds via wire transfer</p>
                    <a href="deposit_wire_transfer.php" class="deposit-link">Initiate Deposit</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="scriptsdp.js"></script> <!-- Link to your existing JavaScript file -->
</body>
</html>
